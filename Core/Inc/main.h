...
#define LED_9_GPIO_Port GPIOF
#define LED_10_Pin GPIO_PIN_1
#define LED_10_GPIO_Port GPIOF
#define LED_11_Pin GPIO_PIN_2
#define LED_11_GPIO_Port GPIOF
#define LED_12_Pin GPIO_PIN_3
#define LED_12_GPIO_Port GPIOF
#define LED_13_Pin GPIO_PIN_4
#define LED_13_GPIO_Port GPIOF
#define LED_14_Pin GPIO_PIN_5
#define LED_14_GPIO_Port GPIOF
#define LED_15_Pin GPIO_PIN_6
#define LED_15_GPIO_Port GPIOF
#define LED_16_Pin GPIO_PIN_7
#define LED_16_GPIO_Port GPIOF
#define LED_17_Pin GPIO_PIN_8
#define LED_17_GPIO_Port GPIOF
#define LED_18_Pin GPIO_PIN_9
#define LED_18_GPIO_Port GPIOF
...
#define BUT_START_Pin GPIO_PIN_4
#define BUT_START_GPIO_Port GPIOB
#define BUT_STOP_Pin GPIO_PIN_5
